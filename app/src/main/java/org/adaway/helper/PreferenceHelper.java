...
public final class PreferenceHelper {
    ...
    public static boolean getVpnDnsLogEnabled(Context context) {
        SharedPreferences prefs = context.getSharedPreferences(
                Constants.PREFS_NAME,
                Context.MODE_PRIVATE
        );
        return prefs.getBoolean(
                context.getString(R.string.pref_vpn_dns_log_key),
                context.getResources().getBoolean(R.bool.pref_vpn_dns_log_def)
        );
    }

    public static void setVpnDnsLogEnabled(Context context, boolean enabled) {
        SharedPreferences prefs = context.getSharedPreferences(
                Constants.PREFS_NAME,
                Context.MODE_PRIVATE
        );
        SharedPreferences.Editor editor = prefs.edit();
        editor.putBoolean(context.getString(R.string.pref_vpn_dns_log_key), enabled);
        editor.apply();
    }
}
